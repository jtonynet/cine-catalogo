...
type Movie struct {
	...
	AgeRating   *int64    `json:"age_rating" binding:"required" example:"12" hateoas:"placeholder=the age rating of movie,required=true,value=12,type=text"`
...
type UpdateMovie struct {
	...
	AgeRating   *int64 `json:"age_rating" example:"12" hateoas:"placeholder=the age rating of movie,required=true,value=12,type=text"`
